// I got all of this from the material UI website
...
/**
 * @param {object} props to be trimmed
  ...
  return (
    <div className={classes.root}>
      ...
      <nav className={classes.drawer} aria-label="mailbox folders">
        {/* The implementation can be swapped with js
            to avoid SEO duplication of links. */}
